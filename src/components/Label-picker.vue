<template>
  <div id="label-wrap">
    <div class="label-show" style="display:flex">
      <el-tag
        class="label-tag"
      ...
      <el-button @click.stop="showPicker=!showPicker" size="small">
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <i
              class="icon edit white"
              style="color:black;font-size:24px;left:0;top:0"
            ></i>
          </button>
        </li>
      </ul>
...
export default {
  ...
  data () {
    return {
      labelData: [
        { id: 1, text: '今天完成', color: 'blue', type: '', picked: false, editting: false },
        { id: 2, text: '明晚完成', color: 'yellow', type: 'success', picked: false, editting: false },
        { id: 3, text: '这个很重要', color: 'red', type: 'danger', picked: false, editting: false },
        { id: 4, text: '不急不急', color: 'green', type: 'warning', picked: false, editting: false },
        { id: 5, text: '随便做做', color: 'black', type: 'info', picked: false, editting: false }
      ],
      showPicker: false
    }
  },
