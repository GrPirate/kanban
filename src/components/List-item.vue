          ...
          <div class="card-default-con">
            ...
            >
              ...
              <div class="card-item-badges">
                ...
                >
                  <i class="icon iconfont gr-icon-calendar"></i>
                  <span>{{timeChange(item.deadline)}}</span>
                </div>
                <div
                  class="badge"
                  title="这张卡片有描述"
                  v-show="Object.keys(item.des).length"
                >
                  <i class="icon iconfont gr-icon-align-left"></i>
                </div>
                <div
                  class="badge"
                  title="评论"
                ...
                >
                  <i class="icon iconfont gr-icon-comments"></i>
                ...
                >
                  <i class="icon iconfont gr-icon-paperclip"></i>
